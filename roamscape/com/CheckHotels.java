...
//            jl1.setVisible(false);
    ...
    CheckHotels(){
        ...
        for(int i = 0 ; i <= 9; i++){
            image[i] = new ImageIcon(ClassLoader.getSystemResource("roamscape/icons/hotel" + (i + 1) + ".jpg"));
...
//        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("roamscape/icons/hotels.gif"));
//        Image i2 = i1.getImage().getScaledInstance(1000,600,Image.SCALE_DEFAULT);
//        ImageIcon i3 = new ImageIcon(i2);
//        jl1 = new JLabel(i3);
//        jl1.setBounds(0,0,1000,600);
//        add(jl1);
        t1 = new Thread(this);
        t1.start();
        setVisible(true);
